...
- **Admin screens.** Subscriptions, subscription detail with a full event timeline, the dunning queue, invoices, the webhook log with replay, and reconciliation history — everything above, visible and actionable without a database client.
